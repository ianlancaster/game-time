...
function GameWorld(height, width, world) {
  ...
  this.initObstacles = function(){
    for(var i = 0; i < this.numberOfWallSections; i++){
      this.ceiling.push(new Obstacle(this.world, this.playerHitBoxes, i*this.obstacleWidth, 0, 20, this.obstacleWidth, this.speed, 'walls',this.rockTexture));
      this.floor.push(new Obstacle(this.world, this.playerHitBoxes, i*this.obstacleWidth, this.height-80, 20, this.obstacleWidth, this.speed, 'walls',this.rockTexture));
    }
    this.drawObstacles();
  };
  ...
  this.shiftWalls = function(){
      ...
      this.ceiling.shift();
      this.ceiling.push(new Obstacle(this.world, this.playerHitBoxes, this.width-1, 0, newHeight, this.obstacleWidth, this.speed, this.viewMode, this.rockTexture));
      this.floor.shift();
      this.floor.push(new Obstacle(this.world, this.playerHitBoxes, this.width-1, this.height-newHeight-60, newHeight, this.obstacleWidth, this.speed, this.viewMode, this.rockTexture));
  };
  ...
  this.createNewRock = function(){
    if(this.rainbowMode === true){
      ...
      this.rocks.push(new Obstacle(this.world, this.playerHitBoxes, 700, this.generateNewRockX(), this.generateNewRockHeight(), 10, this.speed, 'rocks', this.rockTexture));
    }
  };
  ...
  this.drawBackground = function(){
    var waterTexture = this.world.createPattern(this.waterTexture, 'repeat');
    this.world.clearRect(0,0,this.width, this.height);
    this.world.fillStyle = waterTexture;
    this.world.fillRect(0,0,this.width, this.height-80);
  };
